...
class NumberFormatDlg(QDialog):
    ...
    def __init__(self, format, parent=None):
        ...
        self.format = format.copy() #deep copy not affect the original data
    ...
    def accept(self):# selected accept
        class ThousandsError(Exception): pass  #define 2 exception class
